import { APP_VERSION } from "./config.js?v=2.7.2";
import { fraseFilosoficaDoDia } from "./lib/filosofia.js?v=2.7.2";
import {
  criarHabitoAgua,
  ...
  textoPlanoB,
  todosMicroFeitos,
} from "./lib/habitos.js?v=2.7.2";
import {
  carregarPerfil,
  marcarPerfilInicializado,
  perfilInicializado,
  salvarPerfil,
} from "./lib/perfil.js?v=2.7.2";
import {
  correspondePreset,
...
} from "./lib/rotina-preset.js?v=2.7.2";
import {
  ...
  PLANO_B_APRENDER,
  textoSugereAprender,
} from "./lib/aprender.js?v=2.7.2";
import {
  carregarEstudo,
  resetSessaoSeNovoDia,
  salvarEstudo,
} from "./lib/estudo-hub.js?v=2.7.2";
import { iniciarVozes } from "./lib/voz-sintese.js?v=2.7.2";
import {
  atualizarResultadoLivros,
  ligarPainelEstudo,
  renderPainelEstudo,
  renderResumoHoje,
} from "./lib/estudo-ui.js?v=2.7.2";
import {
  ehHorarioDificil,
  mensagemTarde,
  sugestaoTarde,
} from "./lib/tarde.js?v=2.7.2";
import {
  complementoCoachDiario,
  gerarResumoSemana,
  sugerirHabito,
  textoSugestao,
} from "./lib/inteligencia.js?v=2.7.2";
import {
  iniciarVerificacaoLembretes,
  lembretesAtivos,
  pedirPermissaoLembretes,
  verificarLembretes,
} from "./lib/lembretes.js?v=2.7.2";
import { sincronizarAgendaSW } from "./lib/agenda-notif.js?v=2.7.2";
import {
  cancelarTimer,
  cronometroAtivo,
  formatarTimer,
  ...
  textoCountdown,
  timerAtivo,
} from "./lib/foco.js?v=2.7.2";
import {
  carregarPerfilRotina,
  gerarRotina,
  salvarPerfilRotina,
} from "./lib/rotina-local.js?v=2.7.2";
import {
  adicionarInbox,
  alternarPrioridade,
  aplicarLimiteDiario,
